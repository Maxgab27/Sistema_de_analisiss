...
export const Probabilidades: React.FC = () => {
  ...
  useEffect(() => {
    // Recalcular probabilidad calibrada interactiva
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-800">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              disabled={isTraining}
              className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold shadow-lg shadow-indigo-600/20 disabled:opacity-50 transition"
            >
        ...
        {metrics && (
          <div className="bg-slate-950/80 border border-slate-800 p-4 rounded-xl">
            <h4 className="text-xs font-semibold text-slate-300 mb-3 font-mono uppercase tracking-wider">
              Matriz de Confusión ({metrics.total_muestras} muestras analizadas)
            </h4>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center">
              <div className="bg-emerald-950/40 border border-emerald-800/60 p-3 rounded-lg">
                ...
                <span className="text-lg font-mono font-bold text-white mt-1 block">
                  {metrics.matriz_confusion.verdaderos_positivos}
                </span>
              </div>
              <div className="bg-rose-950/40 border border-rose-800/60 p-3 rounded-lg">
                ...
                <span className="text-lg font-mono font-bold text-white mt-1 block">
                  {metrics.matriz_confusion.falsos_positivos}
                </span>
              </div>
              <div className="bg-slate-900 border border-slate-850 p-3 rounded-lg">
                ...
                <span className="text-lg font-mono font-bold text-white mt-1 block">
                  {metrics.matriz_confusion.verdaderos_negativos}
                </span>
              </div>
              <div className="bg-amber-950/40 border border-amber-800/60 p-3 rounded-lg">
                ...
                <span className="text-lg font-mono font-bold text-white mt-1 block">
                  {metrics.matriz_confusion.falsos_negativos}
                </span>
              </div>
            </div>
          </div>
